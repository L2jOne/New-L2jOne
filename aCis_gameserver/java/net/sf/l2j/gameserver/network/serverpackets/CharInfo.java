...
public class CharInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_player.isVip() ? Config.VIP_COLOR : _player.isAio() ? Config.AIO_COLOR : _player.getClient().isDetached() ? Config.OFFLINE_NAME_COLOR : _player.getAppearance().getNameColor());
